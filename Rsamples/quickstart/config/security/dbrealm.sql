...
insert into jeus_users values('SYSTEM_DOMAIN','jeus','amV1cw==');
insert into jeus_users values('SYSTEM_DOMAIN','j2ee_vi','ajJlZV92aQ==');
insert into jeus_users values('SYSTEM_DOMAIN','javajoe','amF2YWpvZQ==');
...
insert into jeus_group_members values('SYSTEM_DOMAIN', 'j2ee','cts_group');
insert into jeus_group_members values('SYSTEM_DOMAIN', 'j2ee_vi', 'cts_group');
insert into jeus_group_members values('SYSTEM_DOMAIN', 'javajoe', 'cts_group');
insert into jeus_group_members values('SYSTEM_DOMAIN', 'jeus', 'system_group');
insert into jeus_group_members values('SYSTEM_DOMAIN', 'anonymous', 'system_group');
