...
public class SamlCallbackHandler implements CallbackHandler {
    ...
    public SamlCallbackHandler() {
        try {
            this.keyStoreURL = home + fileSeparator + ".." + fileSeparator + ".." + "/META-INF/keystore.jks";
            this.keyStoreType = "JKS";
            this.keyStorePassword = "changeit";

            this.trustStoreURL = home + fileSeparator + ".." + fileSeparator + ".." + "/META-INF/cacerts.jks";
    ...
    private static Element createSVSAMLAssertion() {
        ...
        try {
            ...
            NameIdentifier nmId = factory.createNameIdentifier(
                    "CN=SAML User,OU=SU,O=SAML User,L=Los Angeles,ST=CA,C=US", null, // not sure abt this value
                    "urn:oasis:names:tc:SAML:1.1:nameid-format:X509SubjectName");

            SubjectConfirmation scf = factory
                    .createSubjectConfirmation("urn:oasis:names:tc:SAML:1.0:cm:sender-vouches");
            ...
            attributes.add(factory.createAttribute("attribute1", "urn:com:sun:xml:wss:attribute", attributeValues));
    ...
    private static Element createSVSAMLAssertion20() {
        ...
        try {
            ...
            NameID nmId = factory.createNameID("CN=SAML User,OU=SU,O=SAML User,L=Los Angeles,ST=CA,C=US", null,
                    "urn:oasis:names:tc:SAML:2.0:nameid-format:X509SubjectName");

            SubjectConfirmation scf = factory.createSubjectConfirmation(nmId,
            ...
            List attributeValues = new LinkedList();
            attributeValues.add("ATTRIBUTE1");
            attributes.add(factory.createAttribute("attribute1", attributeValues));
    ...
    private Element createHOKSAMLAssertion() {
        ...
        try {
            ...
            List statements = new LinkedList();
            NameIdentifier nmId = factory.createNameIdentifier(
                    "CN=SAML User,OU=SU,O=SAML User,L=Los Angeles,ST=CA,C=US", null,
                    "urn:oasis:names:tc:SAML:1.1:nameid-format:X509SubjectName");
    ...
    private Element createHOKSAMLAssertion20() {
        ...
        try {
            ...
            SubjectConfirmationData scd = factory.createSubjectConfirmationData(null, null, null, null, null, keyInfo
                    .getElement());
            ...
            assertion = factory.createAssertion(assertionID, nmId, issueInstant, conditions, null, subj, statements);
            assertion.setVersion("2.0");
    ...
    private void getDefaultPrivKeyCert(SignatureKeyCallback.DefaultPrivKeyCertRequest request) throws IOException {
        ...
        try {
            ...
            if (uniqueAlias != null) {
                ...
                request.setPrivateKey((PrivateKey) keyStore.getKey(uniqueAlias, keyStorePassword.toCharArray()));
            }
        } catch (Exception e) {
            throw new IOException(e.getMessage());
        }
