...
SET CLASS_PATH=%CLASS_PATH%;%JEUS_HOME%\lib\system\saaj-impl.jar
SET CLASS_PATH=%CLASS_PATH%;%JEUS_HOME%\lib\system\jaxws-rt.jar
SET CLASS_PATH=%CLASS_PATH%;%JEUS_HOME%\lib\system\sjsxp.jar
SET CLASS_PATH=%CLASS_PATH%;%JEUS_HOME%\lib\system\streambuffer.jar
SET CLASS_PATH=%CLASS_PATH%;%JEUS_HOME%\lib\system\stax-ex.jar
SET CLASS_PATH=%CLASS_PATH%;%JEUS_HOME%\lib\system\resolver.jar
