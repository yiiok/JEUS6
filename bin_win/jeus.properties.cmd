...
rem  *  JEUS_BASEPORT   - The base port for JEUS.                             *
...
rem  *  SESSION_MEM     - JVM memory argument                                 *
rem  *                    passed to java for JEUS Session Server              *
...
rem  *      JEUS_HOME, JEUS_BASEPORT, VM_TYPE, JAVA_HOME, JAVA_VENDOR         *
rem  *                                                                        *
...
rem set up JEUS_BASEPORT.
SET JEUS_BASEPORT=@JEUS_BASEPORT@
...
rem Select language for JEUS. Available value cane be en and ko.
SET JEUS_LANG=@SW_LANG@

rem set up SESSION_MEM
...
SET TOOL_OPTION=-Djeus.tm.not_use=true -Djava.net.preferIPv4Stack=true
